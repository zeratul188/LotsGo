...
import { ExpeditionCharacterAvatars } from "./ExpeditionCharacterAvatars";
import { getExpeditionCharacterSummary } from "../lib/expeditionStatSummary";
...
export function ExpeditionStatComponent({
    ...
    return (
        <div className="w-full min-h-[700px]">
            ...
            <ExpeditionCharacterAvatars expeditionCharacters={expeditionCharacters}/>
        </div>
    )
}
...
function Characters({ expeditionCharacters }: { expeditionCharacters: ExpeditionCharacter[] }) {
    ...
    const {
        averageCombatPower,
        averageDealerCombatPower,
        averageSupportCombatPower,
        maxCombatPower,
        minCombatPower,
        averageItemLevel,
        averageDealerItemLevel,
        averageSupportItemLevel,
        maxItemLevel,
        minItemLevel,
        combatPowerByLevelRange
    } = getExpeditionCharacterSummary(characters, expeditionCharacters);
