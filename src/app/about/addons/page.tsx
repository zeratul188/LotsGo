...
export default function Addons() {
    return (
        <div className="w-full [&_p]:text-lg [&_li]:text-lg [&_h3]:text-xl [&_h1]:text-3xl">
            ...
            <img src="/about/addons1.webp" alt="로츠고 경매 계산기" className="w-full h-auto rounded-xl mt-2 mb-2"/>
            ...
            <img src="/about/addons2.webp" alt="로츠고 유물 각인서 시세 목록" className="w-full h-auto rounded-xl mt-2 mb-2"/>
            <p>현재 로스트아크의 유물 각인서 시세를 높은 가격 순서대로 확인하실 수 있습니다.</p>
            <p>유물 각인서 시세 업데이트는 매 정각마다 자동으로 업데이트가 되며, 하루에 1번씩 그 당시의 가격을 매일 기록합니다.</p>
            <img src="/about/addons3.webp" alt="로츠고 유물 각인서 특정 차트" className="w-full h-auto rounded-xl mt-2 mb-2"/>
            <p>"기록 보기"를 통해 해당 유물각인서의 시세가 얼마나 변동하는지 확인하실 수 있습니다.</p>
            <h1 className="font-bold mt-10 mb-2">버스 계산기</h1>
            <img src="/about/addons4.webp" alt="로츠고 버스 계산기" className="w-full h-auto rounded-xl mt-2 mb-2"/>
            <p>
            ...
            <img src="/about/addons5.webp" alt="로츠고 입찰 아이템 분배" className="w-full h-auto rounded-xl mt-2 mb-2"/>
