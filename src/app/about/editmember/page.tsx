...
export default function EditMember() {
    return (
        <div className="w-full [&_p]:text-lg [&_li]:text-lg [&_h3]:text-xl [&_h1]:text-3xl">
            ...
            <img src="/about/editmember1.webp" alt="로츠고 비밀번호 변경" className="w-full h-auto rounded-xl mt-2 mb-2"/>
            <p>설정 페이지에서 "비밀번호 변경" 메뉴를 선택한 다음 현재 비밀번호와 새로운 비밀번호를 입력하시면 즉시 비밀번호가 변경이 됩니다.</p>
            <h1 className="font-bold mt-10 mb-2">회원 탈퇴하기</h1>
            <img src="/about/editmember2.webp" alt="로츠고 회원 탈퇴" className="w-full h-auto rounded-xl mt-2 mb-2"/>
